...
def main():
    ...
    parser.add_argument('--root_folder', type=str, default="./bridge_3000/naive_ConvTransSkip128_do5/", help='input folder of BRAVO images')
    parser.add_argument('--weights_path', type=str, default='model_best_022.pth')
