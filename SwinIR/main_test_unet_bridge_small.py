...
def main():
    ...
    parser.add_argument('--folder_X_te', type=str, default="./bridge_small/X/test/", help='input folder of T1MAP PET images')
    parser.add_argument('--folder_Y_te', type=str, default="./bridge_small/Y/test/", help='input folder of BRAVO images')
    parser.add_argument('--weights_path', type=str, default='./bridge_small/MR-tf6-CT/model_best_032.pth')
    ...
    for path in ["./bridge_small/MR-tf6-CT/pred/"]:
    ...
    for cnt_X, X_path in enumerate(X_list):
        ...
        pred_name = "./bridge_small/MR-tf6-CT/pred/"+"PRD_"+os.path.basename(X_path)[4:7]+".nii.gz"
