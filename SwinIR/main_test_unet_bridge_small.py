...
def main():
    ...
    parser.add_argument('--weights_path', type=str, default='./bridge_small/naive_tf/model_best_046.pth')
    ...
    for path in ["./bridge_small/naive_tf/pred/"]:
    ...
    for cnt_X, X_path in enumerate(X_list):
        ...
        pred_name = "./bridge_small/naive_tf/pred/"+"PRD_"+os.path.basename(X_path)[4:7]+".nii.gz"
