...
def main():
    ...
    parser.add_argument('--save_folder', type=str, default="./NAC_2_SCT/", help='Save_prefix')
    ...
    parser.add_argument('--folder_train_x', type=str, default="./NAC_2_SCT/X/train/", help='input folder of trianing data X')
    parser.add_argument('--folder_train_y', type=str, default="./NAC_2_SCT/Y/train/", help='input folder of training data Y')
    parser.add_argument('--folder_val_x', type=str, default="./NAC_2_SCT/X/val/", help='input folder of validation data X')
    parser.add_argument('--folder_val_y', type=str, default="./NAC_2_SCT/Y/val/", help='input folder of validation data Y')
...
# loss.backward()
    ...
    list_train_x = sorted(glob.glob(args.folder_train_x+"*.nii.gz"))
    list_val_x = sorted(glob.glob(args.folder_val_x+"*.nii.gz"))

    train_loss = np.zeros((args.epoch)) # over the whole process
    epoch_loss_t = np.zeros((len(list_train_x))) # over the training part of each epoch
    epoch_loss_v = np.zeros((len(list_val_x))) # over the validation part of each epoch
